...
public class CASSService {
   ...
   */
  private List<Competency> getCompetencies(final List<String> competencyNames) {
  ...
  /**
   * Expecting this external service will provide all the information that will be required to
   * create a competency in the database if not found.
   *
